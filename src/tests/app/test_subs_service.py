...
from tests.fixture_file_file_info import CHINESE_SUBTITLE_WITH_PINYIN_AND_ENGLISH, ENGLISH_SUBTITLE_ASS, ENGLISH_SUBTITLE_WITH_PINYIN, SUBTITLE_2_EXPECTED_PATH, VIDEO_2_FILE_PATH, VIDEOS_DIR_PATH, get_supported_and_unsupported_fixture,\
...
class TestSubtitleServiceEmbeddedSubs(TestCase):
    '''
